...
- [ ] 9.8 On an actual device, verify approved login routes `platform_admin` to the admin root and professionals to the correct auto-selected or selectable workspace gate, including pending/rejected/inactive/error, refresh, back-block, and root logout behavior.
