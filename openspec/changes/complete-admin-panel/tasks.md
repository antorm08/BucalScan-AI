...
- [x] 5.10 Permitir que `platform_admin` complete ciudad y dirección de centros institucionales mediante backend y Flutter por capas, bloquear aprobación sin ubicación y cubrir autorización, persistencia y presentación con pruebas automatizadas (`118 passed` backend, `237 passed` Flutter y `flutter analyze` limpio).
