...
import 'package:bucalscan_ai/features/clinical/data/services/file_picker_pdf_save_service.dart';
...
final pdfSaveServiceProvider = Provider<PdfSaveService>(
  (ref) => const FilePickerPdfSaveService(),
);
